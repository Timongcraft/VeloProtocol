...
public class BlockEntityDataPacket extends AbstractPacket {
    ...
    public static void register(boolean encodeOnly) {
        PacketRegistration.of(BlockEntityDataPacket.class)
                ...
                .mapping(0x0A, MINECRAFT_1_18_2, encodeOnly)
                .mapping(0x07, MINECRAFT_1_19, encodeOnly)
                .mapping(0x08, MINECRAFT_1_19_4, encodeOnly)
                .mapping(0x07, MINECRAFT_1_20_2, encodeOnly)
                .mapping(0x06, MINECRAFT_1_21_5, encodeOnly)
                .register();
    }
